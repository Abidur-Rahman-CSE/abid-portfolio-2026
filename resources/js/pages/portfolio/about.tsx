            ...
            <div className="max-w-7xl mx-auto px-6 py-12 space-y-20">
                ...
                <div className="border-t border-white/10 pt-16">
                    <div className="text-center max-w-2xl mx-auto mb-12">
                        <div className="text-[#00F0FF] font-mono text-xs tracking-widest uppercase mb-2">// CODE PLAYGROUND</div>
                        <h2 className="text-3xl font-extrabold text-white">Production Engineering Patterns</h2>
                    </div>

                    <div className="rounded-2xl border border-white/15 bg-[#09090e] shadow-2xl overflow-hidden font-mono text-xs max-w-4xl mx-auto">
                        <div className="bg-[#12121c] px-4 py-3 border-b border-white/10 flex items-center justify-between overflow-x-auto">
                ...
                <div className="text-center border-t border-white/10 pt-12">
                    <Link href="/experience" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-[#00F0FF] text-black font-bold text-xs hover:bg-white transition-colors">
